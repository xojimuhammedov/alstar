  ...
  return (
    <Box p="36px 0">
      <Box className="container-mix">
        ...
        <Text {...css.text}>
          When it comes to high-quality aluminium composite panels for façade cladding, ALPOLIC™ is
          the ideal choice. Its superiority is based on a number of unique properties. In summary,
          they form the ALPOLIC™ performance power: durable quality, simple processing,
        ...
        <Text {...css.text}>
          ALPOLIC™ composite panels impress with further clear product advantages such as exact
        ...
        <Text {...css.text}>
          ALPOLIC™ composite panels can be processed directly on site using standard tools and
